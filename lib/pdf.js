...
export function generatePDF(aiReport, rec, posData, bankTxns, acctSheet, acctIssues, baristaData) {
  ...
  // Fractal-noise paper grain (stronger on the page, gentler on cards).
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  body{font-family:'Source Sans 3',sans-serif;font-size:13px;color:#1a1a16;background:${grain(0.16)},linear-gradient(168deg,#faf7f0 0%,#f4ecdd 55%,#efe4d2 100%);background-attachment:fixed;line-height:1.6}
  ...
  /* Section card */
  .card{border:1px solid #d0c8b8;border-radius:8px;padding:18px;margin-bottom:16px;page-break-inside:avoid;background:${grain(0.05)},rgba(255,255,255,.62)}
