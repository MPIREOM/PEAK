...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  body{font-family:'Source Sans 3',sans-serif;font-size:13px;color:#1a1a16;background:linear-gradient(168deg,#faf7f0 0%,#f4ecdd 55%,#efe4d2 100%);line-height:1.6}
  ...
  .card-title{font-size:13px;letter-spacing:.07em;color:#1e3d2f;text-transform:uppercase;font-family:Montserrat,sans-serif;font-weight:800;margin-bottom:14px;padding-bottom:10px;border-bottom:2px solid #c8952a;display:flex;align-items:center;gap:9px}
  .card-title::before{content:"";width:4px;height:15px;background:#c8952a;border-radius:2px;flex-shrink:0}
  ...
  .report-body h3{font-size:13px;letter-spacing:.07em;color:#1e3d2f;text-transform:uppercase;font-family:Montserrat,sans-serif;font-weight:800;margin:22px 0 12px;padding-bottom:9px;border-bottom:2px solid #c8952a;display:flex;align-items:center;gap:9px}
  .report-body h3::before{content:"";width:4px;height:15px;background:#c8952a;border-radius:2px;flex-shrink:0}
